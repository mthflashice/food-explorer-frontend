...
export const StyledFiHeart = styled(FiHeart)`
  ...
  &:hover {
    fill: #B31B1B; // Cor desejada ao passar o mouse
    stroke: #B31B1B; // Cor desejada ao passar o mouse
    cursor: pointer; // Altera o cursor para indicar interatividade
    animation: ${heartbeat} 1.5s ease-in-out infinite; // Adiciona a animação de pulso
  }
`;
